...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mantra-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mantra-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mantra transaction") + "\n" +
              "  mantra-tx [options] -create [commands]   " + _("Create hex-encoded mantra transaction") + "\n" +
              "\n";
