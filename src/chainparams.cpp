...
{
    const char* pszTimestamp = "Jornal de Angola, 25/Feb/2020 - Reformas em Angola destacadas em Genebra";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1582651120, 2085001731, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1eaf0f9f17fc31e1fcb25a0c33dae2dc613d751631086b459b52ecce7d8fa806"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("dnsseed.mantra.net", true);
        //vSeeds.emplace_back("seed-a.mantra.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.mantratools.com", true);
        //vSeeds.emplace_back("dnsseed.mantrapool.org", true);
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xbf, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0xbf, 0x88, 0xAD, 0xE4};
...
*/
        ...
        chainTxData = ChainTxData{
            ...
            1582651120, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.mantratools.com", true);
        vSeeds.emplace_back("seed-b.mantra.loshan.co.uk", true);
