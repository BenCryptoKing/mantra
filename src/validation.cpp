...
#if defined(NDEBUG)
# error "mantra cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "mantra Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MTR additional fees, %d delta bytes\n",
