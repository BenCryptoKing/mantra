...
const char * const BITCOIN_CONF_FILENAME = "mantra.conf";
const char * const BITCOIN_PID_FILENAME = "mantra.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "mantra";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/mantra";
#else
    // Unix
    return pathRet / ".mantra";
#endif
#endif
}
